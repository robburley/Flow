...
@section('content')
    ...
    <div class="container">
        <prospect :prospect="{{ $review->prospect->load(['contacts']) }}"></prospect>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="c-card u-p-medium">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="c-field">
                                {{ $review->reviewable->existing_networks }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="c-field">
                                {{ $review->reviewable->number_of_handsets }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="c-field">
                                {{ $review->reviewable->tablets_or_sim_devices}}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="c-field">
                                {{ $review->reviewable->handsets_working }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="c-field">
                                {{ $review->reviewable->network_or_third_party }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="c-field">
                                {{ $review->reviewable->customer_service_satisfaction }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="c-field">
                                {{ $review->reviewable->customer_service_improvement }}
                            </div>
                        </div>
                    </div>

                    @if($review->reviewable->customer_service_improvement === 'Yes')
                        <div class="row">
                            <div class="col-12 col-md-8">
                            </div>
                            <div class="col-12 col-md-4 u-mb-small">
                                <div class="c-field">
                                    {{ $review->reviewable->customer_service_improvement_detail }}
                                </div>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="c-field">
                                {{ $review->reviewable->signal_and_service }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="c-field">
                                {{ $review->reviewable->monthly_bill }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="c-field">
                                {{ $review->reviewable->bill_fluctuation }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="c-field">
                                {{ $review->reviewable->receives_bill_analysis }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="c-field">
                                {{ $review->reviewable->overseas_calls }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="c-field">
                                {{ $review->reviewable->contract_end_date->format('d/m/Y') }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="c-field">
                                {{ $review->reviewable->add_numbers_after_contact_start }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row u-mt-small">
                    <div class="col-sm-12">
                        <table class="c-table">
                            ...
                            <tbody>
                                @foreach($review->reviewable->documents as $document)
                                    <tr class="c-table__row">
                ...
                <div class="row u-mv-small">
                    <div class="col-12">
                        {!! Form::open(['route' => ['validation.update', $review], 'method' => 'POST']) !!}
                        <button class="c-btn c-btn--success pull-right u-ml-small">
                            Validate
                        </button>
                        {!! Form::close() !!}

                        {!! Form::open(['route' => ['validation.destroy', $review], 'method' => 'DELETE']) !!}
                        <button class="c-btn c-btn--danger pull-right">
                            Invalidate
                        </button>
                        {!! Form::close() !!}
                    </div>
