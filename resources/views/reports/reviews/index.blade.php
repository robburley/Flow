...
@section('content')
    <div class="c-toolbar u-border-bottom">
        ...
        <h3 class="c-toolbar__title">Reviews Report</h3>
    </div>
                    ...
                    <table class="c-table c-table--zebra u-mb-small">
                        <thead class="c-table__head">
                            <tr class="c-table__row">
                                ...
                                <th class="c-table__cell c-table__cell--head">Invalid</th>
                        ...
                        <tbody>
                            @forelse($data as $agent => $stats)
                                <tr class="c-table__row">
                                    ...
                                    <td class="c-table__cell">{{ $stats['created'] }}</td>
                                    <td class="c-table__cell">{{ $stats['completed'] }}</td>
                                    <td class="c-table__cell">{{ $stats['validated'] }}</td>
                                    <td class="c-table__cell">{{ $stats['invalid'] }}</td>
                                    <td class="c-table__cell">{{ $stats['qualified'] }}</td>
                                    <td class="c-table__cell">{{ $stats['not_qualified'] }}</td>
                                </tr>
                            @empty
                                <tr class="c-table__row">
                                    <td class="c-table__cell" colspan="7">No reviews in this date range</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
